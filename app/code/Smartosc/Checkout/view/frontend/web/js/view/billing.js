define([
    ...
    'Smartosc_Checkout/js/model/billing-address/form-popup-state',
    'Smartosc_Checkout/js/action/edit-billing-address',
    ...
    return Component.extend({
        defaults: {
            template: 'Smartosc_Checkout/billing',
            billingFormTemplate: 'Smartosc_Checkout/billing-address/form'
        },
